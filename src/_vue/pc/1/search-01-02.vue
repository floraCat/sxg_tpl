...
<style>
.sxg-search{ position:relative; width:200px; height:40px;}
.sxg-search .keyword{ width:163px; height:34px; line-height:36px; padding:2px 3px; border-right:none;}
.sxg-search .submit{ position:absolute; top:0; right:0; width:30px; height:40px; background: red; cursor:pointer;}
</style>
